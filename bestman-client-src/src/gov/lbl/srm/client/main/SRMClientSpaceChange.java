...
//:::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::
// Class SRMClientSpaceChange
//:::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::

public class SRMClientSpaceChange
{
...
//::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::
// SRMClientSpaceChange
//:::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::


public SRMClientSpaceChange(String[] args, PrintIntf pIntf) {
    ...
    */
      ...
      try {
        statusMaxTimeAllowed = Integer.parseInt(temp);
          ...
          System.out.println(
			"Given -statusmaxtime is not valid, using the default " +
      ...
      try {
        statusWaitTime = Integer.parseInt(temp);
          ...
          System.out.println(
			"Given -statuswaittime is not valid, using the default " +
            statusMaxTimeAllowed);
      }
      i++;
    }
    ...
    if(xxtemp != null) {
     ...
     if(inputFile.equals("")) {
       ...
       if(fileInfo.size() > 0) {
          ...
          util.printMessageHException("\nSRM-CLIENT: No valid files in this request.", pIntf);
          util.printMessageHException("Please check your input.",pIntf);
            inputVec = new Vector ();
     ...
     try {
      ...
      if(fileToken == null || fileToken.equals("")) {
        util.printMessage("SRM-CLIENT: Please provide a valid space token returned by the server", logger,silent);
        util.printMessageHException("SRM-CLIENT: Please provide a valid space token returned by the server", pIntf);
        showUsage(false);
      }
      ...
      util.printMessage("Space token : " + fileToken, pIntf);   
      ...
      if(fileToken == null) {
          ...
          util.printMessageHException
			("\nSRM-CLIENT: Please specify the space token that you want change",pIntf);
          showUsage(false);
      }
...
private Vector  validateURL(Request request) {
  ...
  for(int i = 0; i < size; i++) {
   ...
   if(request.getModeType().equalsIgnoreCase("changespace")) {
...
public void showUsage (boolean b) {
 if(b) { 
    System.out.println("Usage :\n"+
            ...
            "\t-spacetoken        <target space token > (valid space token \n" +
            "\t                      returned by server)\n"+
...
public static void main(String[] args) {
   new SRMClientSpaceChange(args,null);
}
