...
//:::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::
// Class SRMClientSpaceUpdate
//:::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::

public class SRMClientSpaceUpdate 
{
...
//::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::
// SRMClientSpaceUpdate
//:::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::


public SRMClientSpaceUpdate(String[] args, PrintIntf pIntf) {
     ...
     if(proxyFile.equals("")) {
       if(userCert.equals("") && userKey.equals("")) {
         ...
         if(userCert.equals("") || userKey.equals("")) {
           ...
           util.printMessage        
		    ("\nSRM-CLIENT: UserCert and UserKey both should be provided",logger,silent);
           util.printMessageHException 
		    ("\nSRM-CLIENT: UserCert and UserKey both should be provided",pIntf);
           showUsage(false);
         }
       }
     }
     ...
     try {
      ...
      inputVec.addElement("userid="+uid);
        if(tokenSize != 0) {
          ...
          util.printMessage("Using default TokenSize ",pIntf);
        ...
        if(gTokenSize != 0) {
          ...
          util.printMessage("GuaranteedTokenSize  : " + gTokenSize,pIntf);
        }
        else {
          inputVec.addElement("Using default GuaranteedTokenSize");
          util.printMessage("Using default GuaranteedTokenSize ",
			logger,silent);
          util.printMessage("Using default GuaranteedTokenSize ", pIntf);
        }
      ...
      TStatusCode sCode = utilClient.updateToken();
      if(pIntf == null) {
...
public void showUsage (boolean b) {
 if(b) { 
    System.out.println("Usage :\n"+
            ...
            "\tor srm-sp-update <service_url> [command line options] \n" +
            ...
            "\t-size              <integer> for total space in bytes\n"+
            "\t-gsize             <integer> for guaranteed space in bytes\n"+
            "\t-lifetime          <integer> for space lifetime\n"+ 
            ...
            //"\t-userdesc          <user space request description> \n" +
            ...
            "\t-sethttptimeout    <integer in seconds> (enforce SRM/httpg connection timeout and set client-side http connection timeout in the given seconds)default:600 \n"+
	        "\t-quiet             default:false\n" +
...
public static void main(String[] args) {
   new SRMClientSpaceUpdate(args,null);
}
