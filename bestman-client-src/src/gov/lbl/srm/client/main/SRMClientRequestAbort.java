...
public SRMClientRequestAbort(String[] args, PrintIntf pIntf) {
  ...
  try {
    if(!configFileLocation.equals("")) {
      ...
      sys_config = gov.lbl.srm.client.util.Util.parsefile(configFileLocation,"SRM-REQ",silent,useLog, _theLogger);
    }
  }catch(Exception e) {
  ...
  */
  ...
  if(!logPath.equals("")) {
    ...
    if(idx != -1) {
      ...
      try {
         Class c = cl.loadClass("gov.lbl.srm.client.gui.SRMClientRequest");
