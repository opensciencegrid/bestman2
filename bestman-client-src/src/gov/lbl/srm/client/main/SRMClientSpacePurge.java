...
//:::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::
// Class SRMClientSpacePurge
//:::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::

public class SRMClientSpacePurge 
{
...
public SRMClientSpacePurge(String[] args, PrintIntf pIntf) {
    ...
    if(xxtemp != null) {
     ...
     String tempType = "surlType";
       ...
       if(inputFile.equals("")) {
          ...
          if(sourceUrl.equals("")) {
              ...
              util.printMessageHException("\nSRM-CLIENT: Please provide either -s <sourceUrl> ", pIntf);
              util.printMessageHException("or -f <inputFile>",pIntf);
              inputVec.clear(); 
     ...
     try {
       ...
       proxyType=gov.lbl.srm.client.util.Util.getProxyType(properties);
        ...
        util.printMessage("Exception="+ee.getMessage(),logger,silent);
      ...
      if(fileToken == null) {
          ...
          util.printMessageHException
			("\nSRM-CLIENT: Please specify the space token that you want purge",pIntf);
          showUsage(false);
      }
      ...
      TStatusCode sCode = utilClient.purgeFromSpace(fileInfo);
      if(pIntf == null) {
...
private Vector  validateURL(Request request) {
  ...
  for(int i = 0; i < size; i++) {
    ...
    if(request.getModeType().equalsIgnoreCase("purgefromspace")) {
...
public void showUsage (boolean b) {
 if(b) { 
    System.out.println("Usage :\n"+
            "\tsrm-sp-purge -spacetoken <space_token> [command line options]\n" +
            "\tor srm-sp-purge <service_url> [command line options]\n" +
            ...
            "\t                      default:form user default proxy location\n"+
...
public static void main(String[] args) {
   new SRMClientSpacePurge(args,null);
}
