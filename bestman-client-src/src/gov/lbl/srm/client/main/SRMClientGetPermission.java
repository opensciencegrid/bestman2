...
public SRMClientGetPermission(String[] args, PrintIntf pIntf) {
  ...
  try {
    if(!configFileLocation.equals("")) {
      ...
      sys_config = gov.lbl.srm.client.util.Util.parsefile(configFileLocation,"SRM-UTIL",
    ...
    String temp="";
       ...
       if(inputFile.equals("")) { 
        ...
        //by default request is get, so target dir check is done in parseXML
         request = gov.lbl.srm.client.util.Util.parseXML(inputFile,"SRM-UTIL",silent,useLog, _theLogger);
       }
