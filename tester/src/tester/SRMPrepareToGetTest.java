...
public class SRMPrepareToGetTest {

  private SrmPrepareToGetRequest request;
  private Log logger;
  ...
  public SRMPrepareToGetTest (SrmPrepareToGetRequest request, 
	Log logger, StringBuffer proxyStrBuf, boolean dcau, 
    int bufferSize,	PrintIntf pIntf) {  
  ...
  public void doTestStorageParam(String surl, String userDesc,
    String uid, ReportRequestStatus rrs) throws Exception {
  ...
  public void doTestBasic(String surl, TFileStorageType fileStorageType, 
		ReportRequestStatus rrs) throws Exception {
    ...
    if(request.getTargetSpaceToken() != null) {
      util.printMessage("TargetSpaceToken="+request.getTargetSpaceToken(), logger,pIntf);
    }
  ...
  private void includeTransferParameters(String surl,SrmPrepareToGetRequest request) {
    TTransferParameters transferParameters = new TTransferParameters();
  ...
  public SrmPrepareToGetRequest getRequest() {
    return request;
  }
}
