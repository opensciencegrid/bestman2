...
//
//
public class TPermanentSpaceToken extends TSpaceTokenSkeleton {	
    public TPermanentSpaceToken(TTokenAttributes desc, TBasicDevice device) {
	super(desc, device);
	//super.setID(TSRMStorage._DefPermanentTokenPrefix+TSRMUtil.getTokenID());
	super.setID(TSRMSpaceType._DefPermanentTokenPrefix, desc.getTokenID());
    }
	...
	return TFileStorageType.PERMANENT;
    }	      
