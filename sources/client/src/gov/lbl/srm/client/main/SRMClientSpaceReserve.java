...
//:::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::
// Class SRMClientSpaceReserve
//:::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::

public class SRMClientSpaceReserve 
{
...
//::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::
// SRMClientSpaceReserve
//:::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::


public SRMClientSpaceReserve(String[] args, PrintIntf pIntf) {
    ...
    if(xxtemp != null) {
     ...
     try {
       ...
       proxyType=gov.lbl.srm.client.util.Util.getProxyType(properties);
        ...
        util.printMessage("Exception="+ee.getMessage(),pIntf);
        if(pIntf == null) {
         inputVec.clear(); 
     ...
     if(serviceUrl == null) showUsage(false);
      ...
      if(gTokenSize != 0) {
        util.printMessage("GuaranteedTokenSize  : "+gTokenSize,logger,silent);
        util.printMessage("GuaranteedTokenSize  : "+gTokenSize,pIntf);
        inputVec.addElement("GuaranteedTokenSize="+gTokenSize);
      }
      else {
        util.printMessage("Using default GuaranteedTokenSize ", logger,silent);
...
public void showUsage (boolean b) {
 if(b) { 
    System.out.println("Usage :\n"+
            ...
            "\t-userdesc          <user space token description> \n" +
            ...
            "\t-lifetime          <integer> for space lifetime in seconds\n"+ 
            ...
            "\t                      (if provided, request gets submitted only,\n"+
            "\t                      and status needs to be checked separately\n"+
            "\t-statuswaittime   (wait time between status checking in seconds)default:30\n"+
            "\t-statusmaxtime    (maximum time status checking before\n"+
            ...
            "\t                     this option puts the output in the logfile default:./srmclient-event-date-random.log\n"+
            "\t-log              <path to logfile>\n" +
...
public static void main(String[] args) {
   new SRMClientSpaceReserve(args,null);
}
