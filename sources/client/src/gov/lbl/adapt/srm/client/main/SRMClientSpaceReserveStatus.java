...
//:::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::
// Class SRMClientSpaceReserveStatus
//:::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::

public class SRMClientSpaceReserveStatus 
{
...
//::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::
// SRMClientSpaceReserveStatus
//:::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::


public SRMClientSpaceReserveStatus(String[] args, PrintIntf pIntf) {
  ...
  try {
    ...
    if(xxtemp != null) {
     ...
     try {
      ...
      if(rToken.equals("")) {
        util.printMessage("SRM-CLIENT: Please provide a valid space token returned by the SRM server", logger,silent);
        showUsage(false);
      }
      ...
      util.printMessage("RequestToken         : " + rToken,logger,silent);
...
public void showUsage (boolean b) {
 if(b) { 
    System.out.println("Usage :\n"+
            "\tsrm-sp-reserve-status [command line options] \n" +
            "\tor srm-sp-reserve-status <service_url> [command line options] \n" +
            ...
            "\t-authid            (user authorzation id used in SRM)\n"+
            "\t-spacetoken      <space_token> valid space token returned by SRM\n"+
            ...
            //"\t-statuswaittime    (wait time inbetween to check status in seconds default:15)\n"+
...
public static void main(String[] args) {
   new SRMClientSpaceReserveStatus(args,null);
}
