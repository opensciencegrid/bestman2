...
//:::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::
// Class SRMClientGetPermission
//:::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::

public class SRMClientGetPermission
{
...
//::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::
// SRMClientGetPermission
//:::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::


public SRMClientGetPermission(String[] args, PrintIntf pIntf) {
  ...
  try {
    if(!configFileLocation.equals("")) {
      ...
      sys_config = gov.lbl.adapt.srm.client.util.Util.parsefile(configFileLocation,"SRM-UTIL",
    ...
    String temp="";
       ...
       if(inputFile.equals("")) { 
        ...
        //by default request is get, so target dir check is done in parseXML
         request = gov.lbl.adapt.srm.client.util.Util.parseXML(inputFile,"SRM-UTIL",silent,useLog, _theLogger);
       }
...
public void showUsage (boolean b) {
 if(b) { 
    System.out.println("Usage :\n"+
            "\tsrm-permission-get [command line options] -s <source_url> \n"+
            "\tor srm-permission-get <source_url> [command line options] \n" +
            "\tor srm-permission-get [command line options] -f <file>\n" +
...
public static void main(String[] args) {
   new SRMClientGetPermission(args,null);
}
