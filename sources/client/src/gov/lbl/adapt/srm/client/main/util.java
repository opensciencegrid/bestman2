...
public class util {
   ...
   public static HashMap parseRemoteTransferInfo(String remoteTransferInfo) {
    ...
    public static void printMessage(String str, PrintIntf pIntf) {        
	if(pIntf != null) {
	    pIntf.printMessage(str);
	}
    }

    public static void printMessageHL (String str, PrintIntf pIntf) {       
	if(pIntf != null) {
	    pIntf.printMessageHL(str);
	}
    }
    
    public static void printMessageHException(String str, PrintIntf pIntf) {        
	if(pIntf != null) {
	    pIntf.printMessageHException(str);
	}
    }

    public static void printHException(Exception e, PrintIntf pIntf) {        
     if(pIntf != null) {
...
public static boolean isConnectionTimeOut(long startTimeStamp, 
    ...
    SRMClientN.logMsg("timedout, dur(sec):"+retryAllowed, "isConnectionTimeOut", null);
    return true;
}
