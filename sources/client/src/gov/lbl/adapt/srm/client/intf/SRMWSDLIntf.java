...
import gov.lbl.adapt.srm.client.*;
...
public interface SRMWSDLIntf {
  ...
  public String releaseFile(String siteUrl, String rid,int label) 
                throws Exception;
  public void performTransfer(boolean b) throws Exception;
  //pubic void setConcurrency(int concurrency);
  public void doStatusEnquiry() throws Exception;
  public void releaseSpace() throws  Exception;
  public void setGetTypeWSDLIntf(SRMWSDLIntf getTypeRequest);
