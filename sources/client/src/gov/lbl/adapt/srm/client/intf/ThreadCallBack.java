...
public class ThreadCallBack extends Thread {
 ...
 public ThreadCallBack (threadIntf parent) {
    this._parent = parent;
 }
 ...
 public void setCurrentFileToMove (String fileName, String fileSize) {
    this.fileToTransfer = fileName;
...
public String getFileSize () {
 ...
 public void run () {  
   _parent.processThreadRequest(this.fileName);
 }
}
