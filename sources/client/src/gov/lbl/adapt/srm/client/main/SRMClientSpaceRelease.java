...
//:::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::
// Class SRMClientSpaceRelease
//:::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::

public class SRMClientSpaceRelease 
{
...
//::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::
// SRMClientSpaceRelease
//:::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::


public SRMClientSpaceRelease(String[] args, PrintIntf pIntf) {
  ...
  if(!logPath.equals("")) {
    ...
    if(idx != -1) {
      ...
      try {
         ...
         util.printEventLogException(_theLogger,"",snfe);
      }
    }
  }
  else {
    ...
    if(xxtemp != null) {
     ...
     try {
      ...
      if(fileToken == null || fileToken.equals("")) {
        util.printMessage("\nSRM-CLIENT: Please provide a valid space token", logger,silent);
        showUsage(false);
      }
      ...
      TStatusCode sCode = utilClient.releaseSpace(forceFileRelease);
...
public void showUsage (boolean b) {
 if(b) { 
    System.out.println("Usage :\n"+
            ...
            "\tor srm-sp-release <service_url> [command line options]\n" +
...
public static void main(String[] args) {
   new SRMClientSpaceRelease(args,null);
}
