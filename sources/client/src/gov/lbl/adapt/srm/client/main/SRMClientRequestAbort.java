...
//:::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::
// Class SRMClientRequestAbort
//:::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::

public class SRMClientRequestAbort
{
...
//::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::
// SRMClientRequestAbort
//:::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::


public SRMClientRequestAbort(String[] args, PrintIntf pIntf) {
  ...
  try {
    if(!configFileLocation.equals("")) {
      ...
      sys_config = gov.lbl.adapt.srm.client.util.Util.parsefile(configFileLocation,"SRM-REQ",silent,useLog, _theLogger);
    }
  }catch(Exception e) {
  ...
  */
  ...
  if(!logPath.equals("")) {
    ...
    if(idx != -1) {
      ...
      try {
         Class c = cl.loadClass("gov.lbl.adapt.srm.client.gui.SRMClientRequest");
  ...
  try {
    ...
    if(serviceUrl.equals("")) {
     ...
     try {
      ...
      TStatusCode sCode = utilClient.doSrmAbortRequest(requestToken);
...
public void showUsage (boolean b) {
 if(b) { 
    System.out.println("Usage :\n"+
            "\tsrm-req-abort -requesttoken <request_token> [command line options] \n"+
            "\tor srm-req-abort <request_token> [command line options] \n"+
...
public static void main(String[] args) {
   new SRMClientRequestAbort(args, null);
}
