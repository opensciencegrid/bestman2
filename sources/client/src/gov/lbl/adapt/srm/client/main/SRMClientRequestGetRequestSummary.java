...
//:::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::
// Class SRMClientRequestGetRequestSummary
//:::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::

public class SRMClientRequestGetRequestSummary
{
...
//::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::
// SRMClientRequestGetRequestSummary
//:::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::


public SRMClientRequestGetRequestSummary(String[] args, PrintIntf pIntf) {
  ...
  */
  ...
  try {
    ...
    if(inputFile.equals("")) { 
       if(sourceUrl.equals("")) {
           util.printMessage 
	   	     ("\nSRM-REQUEST: Please provide -requesttoken <requesttoken>\n",logger,silent);
           util.printMessage 
		     ("or -f <inputfile>\n",logger,silent);
           util.printMessage 
	   	     ("\nSRM-REQUEST: Please provide -requesttoken <requesttoken>\n",pIntf);
           util.printMessage 
		     ("or -f <inputfile>\n",pIntf);
           inputVec.clear();
	   	   inputVec.addElement ("Please provide -requesttoken <requesttoken> ");
      ...
      request = gov.lbl.adapt.srm.client.util.Util.parseXML(inputFile,"SRM-REQ",silent,useLog,_theLogger);
      request.setModeType("req");
    }
    ...
    if(serviceUrl.equals("")) {
       ...
       if(tt != null) {
         ...
         util.printEventLog(_theLogger,"Error",inputVec,silent,useLog);
         util.printMessage 
          ("\nSRM-REQUEST: Please provide " +
			"the -serviceurl full SRM service url",logger,silent);
         util.printMessage 
          ("\nSRM-REQUEST: Please provide " +
			"the -serviceurl full SRM service url",pIntf);
         util.printMessage 
     ...
     try {
       ...
       proxyType=gov.lbl.adapt.srm.client.util.Util.getProxyType(properties);
        ...
        util.printMessageHException("SRM-REQUEST:Exception="+
			ee.getMessage(),pIntf);
        if(pIntf == null) {
        inputVec.clear();
...
public void showUsage (boolean b) {
 if(b) { 
    System.out.println("Usage :\n"+
            "\tsrm-req-summary -requesttoken <request_token> [command line options]\n"+
            "\tor srm-req-summary <request_token> [command line options]\n"+
            ...
            "\t-sethttptimeout    <integer in seconds> (enforce SRM/httpg connectiontimeout and sets client-side http connection timeout in the given seconds)default:600 \n"+

	        "\t-quiet             default false\n" +
            "\t                      suppress output in the console.\n" +
            "\t                      this option prints the output to a logfile default:./srmclient-event-date-random.log\n" +
            "\t-log              <path to logfile>\n" +
            "\t-debug            default:false\n" +
...
public static void main(String[] args) {
   new SRMClientRequestGetRequestSummary(args, null);
}
