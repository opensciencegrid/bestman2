...
//:::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::
// Class SRMClientRequestGetRequestTokens
//:::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::

public class SRMClientRequestGetRequestTokens
{
...
//::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::
// SRMClientRequestGetRequestTokens
//:::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::


public SRMClientRequestGetRequestTokens(String[] args, PrintIntf pIntf) {
    ...
    if(serviceUrl.equals("")) {
     ...
     try {
       ...
       proxyType=gov.lbl.adapt.srm.client.util.Util.getProxyType(properties);
        ...
        util.printMessageHException("SRM-REQUEST:Exception="+ee.getMessage(),
			pIntf);
        if(pIntf == null) {
        inputVec.clear(); 
      ...
      util.printMessage("UserDesc       : " + userDesc,logger,silent);
      util.printMessage("UserDesc       : " + userDesc,pIntf);
      inputVec.clear(); 
      ...
      System.out.println("\nSRM-CLIENT: Exception from client="+e.getMessage());
                    util.printEventLogException(_theLogger,"",e);
      util.printMessage("SRM-REQUEST:Exception="+e.getMessage(),pIntf);
      if(pIntf == null) {
        inputVec.clear(); 
        inputVec.addElement("StatusCode=92");
        util.printEventLog(_theLogger,"StatusExit",inputVec,silent,useLog);
...
public void showUsage (boolean b) {
 if(b) { 
    System.out.println("Usage :\n"+
            "\tsrm-req-tokens -userdesc <user description> [command line options] \n"+
            "\tor srm-req-tokens <user description> [command line options] \n"+
...
public static void main(String[] args) {
   new SRMClientRequestGetRequestTokens(args, null);
}
