...
//:::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::
// Class SRMClientRequestAbortFiles
//:::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::

public class SRMClientRequestAbortFiles
{
...
//::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::
// SRMClientRequestAbortFiles
//:::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::


public SRMClientRequestAbortFiles(String[] args, PrintIntf pIntf) {
  ...
  try {
    if(!configFileLocation.equals("")) {
      ...
      sys_config = gov.lbl.adapt.srm.client.util.Util.parsefile(configFileLocation,"SRM-REQ",
			silent, useLog,_theLogger);
    }
  }catch(Exception e) {
  ...
  */
  ...
  try {
    ...
    if(inputFile.equals("")) { 
        if(sourceUrl.equals("")) {
           util.printMessage 
	   	     ("\nSRM-COPY: Please provide -s <sourceUrl>\n",logger,silent);
           util.printMessage 
		     ("or -f <inputfile>\n",logger,silent);
           inputVec.clear(); 
    ...
    fileInfo = validateURL(request,false);
    if(fileInfo.size() == 0) {
         inputVec.clear(); 
    ...
    if(serviceUrl.equals("")) {
     ...
     try {
      ...
      if(requestToken == null) { 
          ...
          util.printEventLog(_theLogger,"Error",inputVec,silent,useLog);
          util.printMessage("\nSRM-COPY: Please provide a valid RequestToken",
			logger,silent);
          showUsage(false);
      }
      inputVec.clear(); 
      ...
      util.printEventLog(_theLogger,"Error",inputVec,silent,useLog);
      util.printMessage("\nSRM-COPY: Doing srm Abort files ...",logger,silent);
      TStatusCode sCode = utilClient.doSrmAbortFiles(fileInfo, requestToken);
...
public void showUsage (boolean b) {
 if(b) { 
    System.out.println("Usage :\n"+
            "\tsrm-req-abortfiles -s <source_url> [command line options] \n"+
            "\tor srm-req-abortfiles <source_url> [command line options] \n"+
            "\tor srm-req-abortfiles [command line options] -f <file>\n" +
...
public static void main(String[] args) {
   new SRMClientRequestAbortFiles(args, null);
}
