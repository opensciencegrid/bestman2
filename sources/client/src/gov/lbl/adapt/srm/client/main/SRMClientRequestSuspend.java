...
//:::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::
// Class SRMClientRequestSuspend
//:::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::

public class SRMClientRequestSuspend
{
...
//::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::
// SRMClientRequestSuspend
//:::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::


public SRMClientRequestSuspend(String[] args, PrintIntf pIntf) {
  ...
  try {
    if(!configFileLocation.equals("")) {
      ...
      sys_config = gov.lbl.adapt.srm.client.util.Util.parsefile(configFileLocation,
			"SRM-REQ",silent, useLog,_theLogger);
    }
  }catch(Exception e) {
    ...
    if(serviceUrl.equals("")) {
     ...
     try {
       ...
       proxyType=gov.lbl.adapt.srm.client.util.Util.getProxyType(properties);
        ...
        util.printMessage("SRM-REQUEST:Exception="+ee.getMessage(),
			pIntf);
        if(pIntf == null) {
        inputVec.clear();
      ...
      if(requestToken == null) { 
        util.printMessage("\nSRM-REQUEST: Please provide a valid request token returned by the server", logger,silent);
        util.printMessage("\nSRM-REQUEST: Please provide a valid request token returned by the server", pIntf);
        showUsage(false);
      }
      ...
      System.out.println("\nSRM-CLIENT: Exception from server="+e.getMessage());
        util.printEventLogException(_theLogger,"",e);
      util.printMessageHException("SRM-REQUEST:Exception="+e.getMessage(),
	    pIntf);
      if(pIntf == null) {
        inputVec.clear();
        inputVec.addElement("StatusCode=92");
...
public void showUsage (boolean b) {
 if(b) { 
    System.out.println("Usage :\n"+
            "\tsrm-req-suspend -requesttoken <request_token> [command line options] \n"+
            "\tor srm-req-suspend <request_token> [command line options] \n"+
...
public static void main(String[] args) {
   new SRMClientRequestSuspend(args, null);
}
