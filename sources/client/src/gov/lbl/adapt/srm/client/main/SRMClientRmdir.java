...
//:::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::
// Class SRMClientRmdir
//:::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::

public class SRMClientRmdir
{
...
public SRMClientRmdir(String[] args, PrintIntf pIntf) {
  ...
  */
  ...
  if(!logPath.equals("")) {
    ...
    if(idx != -1) {
      ...
      try {
         Class c = cl.loadClass("gov.lbl.adapt.srm.client.main.SRMClientDirectory");
  ...
  try {
    ...
    if(serviceUrl.equals("") && !doLocalLsList && !doGridFTPList) {
     ...
     if(_debug) {
      ...
      util.printMessage("\tdoLocalList="+doLocalLsList,pIntf);
      ...
      */
      ...
      //TStatusCode sCode = utilClient.doSrmRmdir
      String sCode = utilClient.doSrmRmdir
		(fileInfo,recursive,doLocalLsList,doGridFTPList);
      ...
      util.printMessage("\nSRM-DIR: Exception from server=" + e.getMessage(),logger,silent);
        util.printEventLogException(_theLogger,"",e);
...
private Vector  validateURL(Request request) {
  ...
  for(int i = 0; i < size; i++) {
    ...
    if(request.getModeType().equalsIgnoreCase("dir")) {
       ...
       else if(simpleURL && doLocalLsList || simpleURL && doGridFTPList) {
          inputVec.clear(); 
...
public void showUsage (boolean b) {
 if(b) { 
    System.out.println("Usage :\n"+
            "\tsrm-rmdir <source_url> command line options]\n" +
            "\tor srm-rmdir -s <source_url> command line options]\n" +
            "\tor srm-rmdir -s <source_url> -s <source_url> command line options]\n" +
            //"\tor srm-rmdir -s <source_url>&<source_url> command line options]\n" +
            "\tor srm-rmdir [command line options] -f <file>\n" +
            ...
            "\t-recursive         (recursively removes dir for the source url)default:false\n" +
