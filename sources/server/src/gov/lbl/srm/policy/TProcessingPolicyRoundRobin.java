...
class TGeneralRoundRobin {
	...
	HashMap _hashedCollection = new HashMap();
        TSRMMutex _entryMutex = new TSRMMutex();
...
public class TProcessingPolicyRoundRobin extends TGeneralRoundRobin implements IProcessingPolicy{
	...
	private void doubleCheck(Object job) throws InterruptedException { 
        ...
        public int drainTo(java.util.Collection c, int i) {
	    throw new RuntimeException("Do not support drainTo(c, i)");
	}

        public int drainTo(java.util.Collection c) {
	    throw new RuntimeException("Do not support drainTo()");
	}

        public boolean contains(java.lang.Object o) {
	    throw new RuntimeException("Do not support contains()");
	}


        public boolean remove(java.lang.Object o) {
	    throw new RuntimeException("Do not support remove()");
	}
	...
	public void put(Object job) throws InterruptedException {
	    ...
	    throw new RuntimeException("Do not support remainingCapacity()");
	}
        ...
        public boolean offer(java.lang.Object item, long msecs, java.util.concurrent.TimeUnit tu) throws InterruptedException {
	    return offer(item);
	}
    ...
    public Object poll() {return null;} // from class Queue
    public Object remove() {return null;} // from class Queue
    public void clear() {}; // from class Collection
    public boolean retainAll(java.util.Collection c) {return true;} // from class Collection
    public boolean removeAll(java.util.Collection c) {return true;} // from class Collection
    public boolean addAll(java.util.Collection c) {return true;} // from class Collection
    public boolean containsAll(java.util.Collection c) {return true;} // from class Collection
    public Object[] toArray() {return  null;} // from class Collection
    public Object[] toArray(Object[] c) {return  null;} // from class Collection
    public java.util.Iterator iterator() {return  null;} // from class Collection
    public boolean isEmpty() {return  false;} // from class Collection
    public int size() {return  0;} // from class Collection
        public Object poll(long msecs, java.util.concurrent.TimeUnit tu) throws InterruptedException {
