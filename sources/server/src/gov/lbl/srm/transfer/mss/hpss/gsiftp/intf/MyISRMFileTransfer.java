...
package gov.lbl.srm.transfer.mss.hpss.gsiftp.intf;
...
public interface MyISRMFileTransfer extends ISRMFileTransfer {
   public void setTransferType(SRMTransferProtocol protocol);
   public void setTransferMode(SRMTransferMode mode);
   public void setBufferSize(int bufferSize);
   public void setParallel(int parallelism);
   public void setDCAU(boolean b);
   public void setCredentials(GSSCredential credential);
   public void setLogger(Log log,java.util.logging.Logger logger, boolean b,boolean debug);
   public void start();
   public void stop();
