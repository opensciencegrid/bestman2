...
public synchronized Object checkStatus (String requestToken) 
   ...
   if(statusObj != null) {
       if(statusObj instanceof SRM_MSSFILE_STATUS) {
		...
		pftpmssg != MSS_MESSAGE.SRM_MSS_PROCESS_KILLED) {
		...
		mssIntf mssintf) throws Exception 
{
   ...
   if(othersQueue.getSize() >= sizeOfOthersQueue) {
     ...
     param[2] = "queuesize = " + othersQueue.getSize() + " and maximumQueueSize " 
			+ sizeOfOthersQueue;
     _theLogger.log(java.util.logging.Level.FINE,
		"TRANSFER_FAILED", (Object[]) param);
     throw new SRM_MSS_Exception
		  ...
		  mssIntf mssintf) throws Exception 
{
   ...
   if(othersQueue.getSize() >= sizeOfOthersQueue) {
     ...
     param[0] = "SOURCE="+path;
     param[1] = "EXPLANATION=Others Queue is busy";
     param[2] = "queuesize " + othersQueue.getSize();
     param[3] = "maximumsizeofothersqueue " + sizeOfOthersQueue;
     _theLogger.log(java.util.logging.Level.FINE,
		"TRANSFER_FAILED", (Object[]) param);
     throw new SRM_MSS_Exception
		("Others queue is busy, please try this request later");
