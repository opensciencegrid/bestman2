...
public class TProcessingUnitUploadingQueue extends TProcessingUnit {
    protected static PooledExecutor _outgoingTxfPool = null;
	...
	_outgoingTxfPool = new PooledExecutor(getProcessingPolicy());
	_outgoingTxfPool.setMinimumPoolSize(poolSize);
